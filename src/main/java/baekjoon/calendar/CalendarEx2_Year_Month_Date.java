...
public class CalendarEx2_Year_Month_Date {
    public static void main(String[] args) {
        ...
        //month의 경우 0부터 시작하기 때문에 8월인 경우, 7로 지정 해야 한다.
        //date.set(2015, 7, 15) -> 2015년 8월 15일 날짜로 설정한다.
        ...
        //두 날짜간의 차이를 얻으려면, getTimeMills() 천분의 일초 단위로 변환해야 한다.
